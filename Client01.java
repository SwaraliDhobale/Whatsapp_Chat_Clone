...
import java.net.*;
import java.io.*;
public class Client01 implements ActionListener {     
    JTextField t;
    static JPanel p1;
    ...
    Client01(){
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icons/flower.jpg"));
        ...
        JLabel name=new JLabel("Swarali");
        ...
        f.add(p1);
        ImageIcon j=new ImageIcon("icons/flower.jpg");
        JLabel b9=new JLabel(j);
        b9.setBounds(5,10,30,30);
        f.add(b9);
        f.add(p1);
